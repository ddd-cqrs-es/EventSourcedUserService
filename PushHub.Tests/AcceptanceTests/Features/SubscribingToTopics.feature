...
Scenario: Subscribing for a topic
	...
	And a publisher has registered a topic "http://localhost:2113/UserEvents1"
	And a subscriber callback is configured to listen at "http://localhost:8080" with a prefix of "http://+:8080/"
	When I subscribe for the topic "http://localhost:2113/UserEvents1"
	...
	#When I unsubscribe from the topic "http://localhost:2113/UserEvents1"
	#Then the hub does not list the topic "http://localhost:2113/UserEvents1"